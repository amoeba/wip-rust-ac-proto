...
impl crate::writers::ACWritable for CommunicationChannelIndex {
    fn write(&self, writer: &mut dyn ACWriter) -> Result<(), Box<dyn std::error::Error>> {
        #[cfg(feature = "tracing")]
        let _span = tracing::span!(tracing::Level::DEBUG, "write", r#type = "CommunicationChannelIndex").entered();

        write_packable_list::<String>(writer, &self.channels)?;
        Ok(())
    }
}
